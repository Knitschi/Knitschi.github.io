...
set_target_properties(c::CPackage PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/CPackage-debug.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/./CPackage-debug.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS c::CPackage )
list(APPEND _IMPORT_CHECK_FILES_FOR_c::CPackage "${_IMPORT_PREFIX}/lib/CPackage-debug.lib" "${_IMPORT_PREFIX}/./CPackage-debug.dll" )
...
set_target_properties(c::CPackage_fixtures PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/CPackage_fixtures-debug.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/./CPackage_fixtures-debug.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS c::CPackage_fixtures )
list(APPEND _IMPORT_CHECK_FILES_FOR_c::CPackage_fixtures "${_IMPORT_PREFIX}/lib/CPackage_fixtures-debug.lib" "${_IMPORT_PREFIX}/./CPackage_fixtures-debug.dll" )
...
set_target_properties(c::CPackage_tests PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/./CPackage_tests-debug.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS c::CPackage_tests )
list(APPEND _IMPORT_CHECK_FILES_FOR_c::CPackage_tests "${_IMPORT_PREFIX}/./CPackage_tests-debug.exe" )
